...
<body>
	...
	<div class="special">
		...
		<br><br><br><p class="special" id="specialCheck"><br><br>
			<input 
				type="checkbox" 
				value="no" 
				onclick="CheckboxChecked(this.checked,'reveal')">
			I had a peculiar birth!
		</p>		
		<div class="special" id="reveal" style="display:none">
			<p>
				I was born
				<input type="number" min="0" value="0" max="365" class="birthday" name="offset" id="offset">
		...
		<script type="text/javascript">
			CheckboxChecked(document.myform.snowflake.checked,'reveal');
		</script>
	</div>
	...
	<div class="info">
		...
		<a href="https://github.com/LiterallyElvis/Porktrack"><img style="position: absolute; bottom: 0; right: 0; border: 0;" src="images/forkme.png" alt="Pork me on GitHub" data-canonical-src="images/forkme.png"></a>
	</div>
